export default function BtnDelete({
  ...
  if (deleteQuestion == undefined) return;
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      x="0px"
      y="0px"
      className="opacity-0 right-0 fill-red-800 hover:fill-gray-700 group-hover:opacity-100 ransition-opacity duration-300 cursor-pointer absolute w-5 h-5"
